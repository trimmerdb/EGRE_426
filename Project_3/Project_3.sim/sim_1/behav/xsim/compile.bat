...
REM
REM Generated by Vivado on Wed Oct 29 13:32:10 -0400 2025
...
echo "xvhdl --incr --relax -prj SignExtend_tb_vhdl.prj"
call xvhdl  --incr --relax -prj SignExtend_tb_vhdl.prj -log xvhdl.log
