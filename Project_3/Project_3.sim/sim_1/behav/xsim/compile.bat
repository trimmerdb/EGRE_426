...
REM
REM Generated by Vivado on Wed Oct 08 15:59:22 -0400 2025
...
echo "xvhdl --incr --relax -prj top_level_sherif_tb_vhdl.prj"
call xvhdl  --incr --relax -prj top_level_sherif_tb_vhdl.prj -log xvhdl.log
